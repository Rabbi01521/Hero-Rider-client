...
const RiderSignup = () => {
  ...
  const handleOnChange = (e) => {
    ...
    const newRegisterData = { ...registerData, image, nidImage, licenceImage };
  ...
  const handleRegisterSubmit = (e) => {
    ...
    formData.append("rideInfo", registerData.rideInfo);
    formData.append("type", "rider");

    formData.append("licenceImage", registerData.licenceImage);
  ...
  return (
    <div>
      ...
      >
        <Typography variant="h5">Join as Rider</Typography>
        {!isLoading && (
          <form onSubmit={handleRegisterSubmit} style={{ textAlign: "center" }}>
            ...
            <h4 style={{ textAlign: "left", marginLeft: "132px" }}>
              Enter Your Driving Licence Picture
            </h4>
            <Input
              sx={{ width: "75%", m: 1 }}
              accept="image/*"
